...
const ReportsModal = ({ show, onClose, item }) => {
    ...
    if (show && item) {
      const loadReportDetails = async () => {
        try {
          setLoading(true);
          setError(null);
          const report = await getOrderReportById(item.id); // Use the correct API function
    ...
    >
      ...
      >
          ...
          <>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <textarea
                  value={
                    detailedReport.order_types && detailedReport.order_types.length > 0
        ...
        <div className="flex justify-end mt-2">
          <button
            className="bg-red-500 text-white border border-white px-4 py-2 rounded-md hover:bg-red-600"
            onClick={onClose}
          >
            Close
          </button>
