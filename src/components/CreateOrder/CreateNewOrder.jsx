...
const [orders, setOrders] = useState([
  { serialNumber: '', quantity: '', serviceTypes: [], remainingQuantity: null, machineDescription: '' },
]);
...
const [stocks, setStocks] = useState([]);
  ...
  const checkRemainingQuantity = (index, serialNumber) => {
    ...
    const updatedOrders = [...orders];
    if (stockItem) {
      updatedOrders[index].remainingQuantity = stockItem.quantity;
      updatedOrders[index].machineDescription = stockItem.machine_description; // Update description here
    } else {
      updatedOrders[index].remainingQuantity = null;
      updatedOrders[index].machineDescription = ''; // Reset description if not found
    }
    setOrders(updatedOrders);
  };
    ...
    <div className="min-h-screen mx-auto p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-200">
        <form onSubmit={handleSubmit}>
          {/* Client Information */}
          {/* ...client input fields similar to original code */}
  ...
  {order.machineDescription && (
    <p className="text-lg">
      <span className="text-black font-semibold">Machine Description:</span>{' '}
      <span className="text-blue-800 font-semibold">{order.machineDescription}</span>
    </p>
  )}
</div>
